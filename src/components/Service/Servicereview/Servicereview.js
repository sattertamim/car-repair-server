...
const Servicereview = ({ modalIsOpen, closeModal, serviceOn, date }) => {
    ...
    return (
        ...
        >
            <h2 className="text-center text-brand">{serviceOn}</h2>
            ...
            <form className="p-5" onSubmit={handleSubmit(onSubmit)}>
                ...
                <div className="form-group row">
                    ...
                    <div className="col-4">
                        <input ref={register({ required: true })} className="form-control" name="review" placeholder="review" type="text" />
